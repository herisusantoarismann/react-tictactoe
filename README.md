...
1. Clone the repo
   ```sh
   git clone https://github.com/herisusantoarismann/react-tictactoe
   ```
...
Project Link: [https://github.com/herisusantoarismann/react-tictactoe](https://github.com/herisusantoarismann/react-tictactoe)
